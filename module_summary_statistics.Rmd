...
```{r}
pheatmap::pheatmap(data.matrix(nmi_score$DLPFC),fontsize = 15,main='DLPFC')
```
```{r}
pheatmap::pheatmap(data.matrix(nmi_score$CBE),fontsize = 15,main='CBE')
```
```{r}
pheatmap::pheatmap(data.matrix(nmi_score$TCX),fontsize = 15,main='TCX')
```
