...
figObj<-synapseClient::File(module_size_loc,parentId=figureSynId)
annos <- c('analysisType'='visualization',
           'fileFormat'='tif',
           'consortium'='AMP-AD')
synapseClient::synSetAnnotations(figObj) <- as.list(annos)

permLink <- githubr::getPermlink('blogsdon/AMPADManuscript','module_summary_statistics.Rmd')
